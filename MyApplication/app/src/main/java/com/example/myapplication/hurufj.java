...
public class hurufj extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_hurufj);
    ...
    private void playSound(int arg){
        try{
            ...
            Toast.makeText(this, "Membaca Huruf J ", Toast.LENGTH_LONG).show();
        }
        if (arg==1){
            Toast.makeText(this, isPlaying+"Huruf J", Toast.LENGTH_LONG).show();
            player = MediaPlayer.create(this, R.raw.hurufj);
        }
        //player.setLooping();
        player.start();
    }
    ...
    public void bt_datahuruf(View view){
        Toast.makeText(hurufj.this,"Mengenal Huruf",
