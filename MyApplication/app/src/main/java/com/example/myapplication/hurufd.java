...
public class hurufd extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_hurufd);
    ...
    private void playSound(int arg){
        try{
            ...
            Toast.makeText(this, "Membaca Huruf D ", Toast.LENGTH_LONG).show();
        }
        if (arg==1){
            Toast.makeText(this, isPlaying+"Huruf D", Toast.LENGTH_LONG).show();
            player = MediaPlayer.create(this, R.raw.hurufd);
        }
        //player.setLooping();
        player.start();
    }
    ...
    public void bt_datahuruf(View view){
        Toast.makeText(hurufd.this,"Mengenal Huruf",
