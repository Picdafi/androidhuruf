...
public class hurufg extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_hurufg);
    ...
    private void playSound(int arg){
        try{
            ...
            Toast.makeText(this, "Membaca Huruf G ", Toast.LENGTH_LONG).show();
        }
        if (arg==1){
            Toast.makeText(this, isPlaying+"Huruf G", Toast.LENGTH_LONG).show();
            player = MediaPlayer.create(this, R.raw.hurufg);
        }
        //player.setLooping();
        player.start();
    }
    ...
    public void bt_datahuruf(View view){
        Toast.makeText(hurufg.this,"Mengenal Huruf",
