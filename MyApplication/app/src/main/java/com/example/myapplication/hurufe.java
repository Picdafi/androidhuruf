...
public class hurufe extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_hurufe);
    ...
    private void playSound(int arg){
        try{
            ...
            Toast.makeText(this, "Membaca Huruf E ", Toast.LENGTH_LONG).show();
        }
        if (arg==1){
            Toast.makeText(this, isPlaying+"Huruf E", Toast.LENGTH_LONG).show();
            player = MediaPlayer.create(this, R.raw.hurufe);
        }
        //player.setLooping();
        player.start();
    }
    ...
    public void bt_datahuruf(View view){
        Toast.makeText(hurufe.this,"Mengenal Huruf",
