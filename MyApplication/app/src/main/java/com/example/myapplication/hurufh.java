...
public class hurufh extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_hurufh);
    ...
    private void playSound(int arg){
        try{
            ...
            Toast.makeText(this, "Membaca Huruf H ", Toast.LENGTH_LONG).show();
        }
        if (arg==1){
            Toast.makeText(this, isPlaying+"Huruf H", Toast.LENGTH_LONG).show();
            player = MediaPlayer.create(this, R.raw.hurufh);
        }
        //player.setLooping();
        player.start();
    }
    ...
    public void bt_datahuruf(View view){
        Toast.makeText(hurufh.this,"Mengenal Huruf",
